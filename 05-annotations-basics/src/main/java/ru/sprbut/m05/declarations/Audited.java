 ...
 * <p>
 * Аннотация с этой мета-аннотацией «спускается» на подклассы: если она стоит
 * на родителе, {@code subclass.getAnnotation(Audited.class)} её найдёт.
 * <p>
 * Две ловушки, которые почти всегда становятся сюрпризом:
 * <ul>
