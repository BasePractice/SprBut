...
@ConditionalOnProperty(
    prefix = "sprbut.greeter", name = "enabled", havingValue = "true", matchIfMissing = true
)
...
public class GreeterAutoConfiguration {
     ...
     */
    public GreeterAutoConfiguration() {
     ...
     * @return Бин появится, только если пользователь не объявил свой {@link Greeter}
     */
    @Bean
