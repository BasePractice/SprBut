...
чем стали его бины, во что они обёрнуты, какие методы перехвачены, какие маршруты
просматривает `DispatcherServlet` и через какую цепочку фильтров запрос до него
добирается.
